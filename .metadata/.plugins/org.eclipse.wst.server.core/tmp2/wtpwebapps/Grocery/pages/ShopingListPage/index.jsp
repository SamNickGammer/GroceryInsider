...
<body>
        ...
        <div class="displayFlexCont">
            <div class="navBarContainer">
                <section class="header navbar">
                    <div class="logoName" onclick="window.location.href = '../../index.jsp';">
                        <div class="logoSVG">
                    ...
                    <div class="searchAndLocation">
                        <div class="searchBarCont">
                            <input type="text" class="searchBar" placeholder="Search" onkeydown="event.key == 'Enter'? window.location.href = 'index.jsp?q='+this.value:''">
            ...
            <div class="bodyContainer">
                <div class="bodyContFlex">
                    <div class="sideBar padding0 scrollCont">
    ...
    <iframe class="productIFrame" src="../ProductPagePopup/productPopup.jsp" frameborder="0"></iframe>

		<%
			String querySearch = request.getParameter("q");
			String category = request.getParameter("c");
			String subCategory = request.getParameter("s");
			String strb = null;
			String cartdt = null;
			if(querySearch != null){
				strb = obj.getProducts(null, null, querySearch, null);
			}
			if(category != null){
				strb = obj.getProducts(category, subCategory, null, null);
			}
			cartdt = obj.cartGet("9660102328");
		%>
		<script>
			var data = <%=strb%>
			var cart = <%=cartdt%>
